...
const config: HardhatUserConfig = {
    ...
    networks: {
        // Robinhood Chain mainnet (chainId 4663). Endpoint/ULN/executor addresses come from
        // @layerzerolabs/lz-evm-sdk-v2 deployments/robinhood-mainnet via the eid.
        'robinhood-mainnet': {
            eid: EndpointId.ROBINHOOD_V2_MAINNET,
            url: process.env.RPC_URL_ROBINHOOD || 'https://rpc.mainnet.chain.robinhood.com',
            accounts,
        },
        // Robinhood Chain testnet (chainId 46630). No Uniswap v4 here; used only to rehearse the bridge.
        'robinhood-testnet': {
